...
from grpc_interceptor.testing.protos import dummy_pb2 as grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2
...
class DummyService(object):
    ...
    def ExecuteClientStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/DummyService/ExecuteClientStream',
            grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2.DummyRequest.SerializeToString,
            grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2.DummyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ExecuteServerStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/DummyService/ExecuteServerStream',
            grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2.DummyRequest.SerializeToString,
            grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2.DummyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ExecuteClientServerStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/DummyService/ExecuteClientServerStream',
            grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2.DummyRequest.SerializeToString,
            grpc__interceptor_dot_testing_dot_protos_dot_dummy__pb2.DummyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
